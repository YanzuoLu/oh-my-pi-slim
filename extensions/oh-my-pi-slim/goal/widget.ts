...
import type { GoalExecutionStats, GoalStatus, GoalView } from "./runtime.js";
...
function statusRole(status: GoalStatus): "accent" | "warning" | "dim" | "success" {
 ...
 * or parked must never hide its elapsed time, continuations, runs, or token cost.
