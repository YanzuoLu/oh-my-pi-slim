...
export class LoopRuntime {
  ...
  registerTool(): void {
    ...
    this.pi.registerTool({
      ...
      description: "Create and manage runtime-only repeating fixed-delay prompts.",
      promptSnippet: "Create or manage runtime-only repeating fixed-delay prompts by loop ID.",
      promptGuidelines: [
