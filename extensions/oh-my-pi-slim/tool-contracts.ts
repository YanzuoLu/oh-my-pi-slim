...
export const MONITOR_TOOL_DESCRIPTIONS = {
  tool: markdown(
    ...
    "",
    "Commands can filter and line-buffer their output when each line should represent a distinct event. Each monitor runs in its own process group. Available only on POSIX.",
  ),
  input: {
